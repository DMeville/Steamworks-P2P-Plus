...
public class NetworkMessage {
    ...
    public NetworkEntity entity = null; //if we have a queued message then the entity is destroyed. It would lose it's ref and think it's a global event! Can't have that!
