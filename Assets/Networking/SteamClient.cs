...
public class SteamClient : MonoBehaviour
{
    ...
    //    //Debug.Log(Serializing message of type: " + msgType);
    ...
    //D and S can be shared, since we have different message types and process is per message type
    //public void D(int msgType, byte[] data) {
    //    //Debug.Log("Deserializing message of type: " + msgType);
    //    bool arg0 = SerializerUtils.ReadBool(ref data);
    //    bool arg1 = SerializerUtils.ReadBool(ref data);

    //    NetworkManager.instance.Process(msgType, arg0, arg1);
    //}
	
    //public void OnMessage0Rec(params object[] args) {
    //    bool arg0 = (bool)args[0];
    //    bool arg1 = (bool)args[1];

    //    Debug.Log("OnMessage0Rec: " + arg0 + " : " + arg1);
    //}
